...
export const ROLE_DESCRIPTIONS: Record<AppRole, string> = {
  ROOT:
    "Полный доступ к рабочему пространству: команды, задачи, назначения и администрирование.",
  PM:
    "Может управлять задачами и назначать исполнителей, но не создает команды.",
  EMPLOYEE:
